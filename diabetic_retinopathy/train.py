    ...
    def train(self):
        ...
        for idx, (images, labels) in enumerate(self.ds_train):
            ...
            if step % self.ckpt_interval == 0:
                save_path = tf.train.Checkpoint(optimizer=self.optimizer, model=self.model)
            ...
            if step % self.total_steps == 0:
                ...
                save_path = tf.train.Checkpoint(optimizer=self.optimizer, model=self.model) # 保存最终的检查点
